...
class LoggingUtils @Inject() (auditable: Auditable) extends Logging {
  ...
  def audit(
    ...
    ): Unit = splunkFunction(transactionName, detail, eventType)
  ...
  @inline def trace(
      ...
      detail:          Map[String, String],
      eventType:       String = ""
    ): Unit = trace(splunkToLogger(transactionName, detail, eventType))
  ...
  @inline def debug(
      ...
      detail:          Map[String, String],
      eventType:       String = ""
    ): Unit = debug(splunkToLogger(transactionName, detail, eventType))
  ...
  @inline def info(
      ...
      detail:          Map[String, String],
      eventType:       String = ""
    ): Unit = info(splunkToLogger(transactionName, detail, eventType))
  ...
  @inline def warn(
      ...
      detail:          Map[String, String],
      eventType:       String = ""
    ): Unit = warn(splunkToLogger(transactionName, detail, eventType))
